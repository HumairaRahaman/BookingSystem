...
public class BookingSystem {
    ...
    public boolean changeAppointment(String oldAppointmentId, String newAppointmentId, String patientId) {
        ...
        // Check if patient already has another appointment at this new time (excluding the old one)
        ...
        if (!booked) {
            // Try to restore old appointment if new booking fails
            oldAppointment.book(patient);
            return false;
        }
    ...
    public String generateReport() {
        ...
        // 2. List physiotherapists in descending order of attended appointments
        report.append("\n\nPHYSIOTHERAPISTS BY ATTENDANCE\n");
        report.append("=============================\n");

        // Create a map of physiotherapist to attended appointment count
    ...
    public void initializeSampleData() {
        ...
        Physiotherapist p1 = new Physiotherapist("PT001", "John Smith", "123 Main St", "555-1111");
        p1.addExpertise("Physiotherapy");
        p1.addExpertise("Rehabilitation");

        Physiotherapist p2 = new Physiotherapist("PT002", "Helen Johnson", "456 Elm St", "555-2222");
        p2.addExpertise("Osteopathy");
        p2.addExpertise("Rehabilitation");

        Physiotherapist p3 = new Physiotherapist("PT003", "David Lee", "789 Oak St", "555-3333");
        ...
        // Create appointments for the 4-week timetable
