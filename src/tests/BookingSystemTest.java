...
public class BookingSystemTest {
    ...
    public void testChangeAppointmentFailsWithTimeConflict() {
        ...
        Appointment appointment2 = new Appointment(now, now.plusHours(1), physio2, treatment2);
        ...
        bookingSystem.bookAppointment(appointment1.getId(), patient1.getId());
        bookingSystem.bookAppointment(appointment2.getId(), patient1.getId());
        ...
        assertEquals(AppointmentStatus.BOOKED, appointment2.getStatus());
    }
